...
import { LeftPanelTabValue } from '@fluxly/models';
...
const tabs: {
    ...
    [
        ...
        },
        {
            ...
            icon: <Icons.ComponentInstance className="w-5 h-5" />,
...
export const DesignPanel = observer(() => {
    ...
    return (
        ...
        >
            ...
            <div className="w-20 flex flex-col items-center py-0.5 gap-2 bg-background-fluxly/60 backdrop-blur-xl">
                {tabs.map((tab) => (
                    <button
                        key={tab.value}
                        className={cn(
