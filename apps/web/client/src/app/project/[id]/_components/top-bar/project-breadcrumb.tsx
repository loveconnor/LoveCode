...
import { ProductType } from '@fluxly/stripe';
import { Badge } from '@fluxly/ui/badge';
        ...
        <div className="mr-0 flex flex-row items-center text-small gap-2">
            <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
                <DropdownMenuTrigger asChild>
                    <Button
                        variant='ghost'
                        className="ml-1 px-0 gap-2 text-foreground-fluxly text-small hover:text-foreground-active hover:!bg-transparent cursor-pointer group"
                    >
                        <Icons.FluxlyLogo
                            className={cn(
                        ...
                        />
                        <span className="mx-0 max-w-[60px] md:max-w-[100px] lg:max-w-[200px] px-0 text-foreground-fluxly text-small truncate cursor-pointer group-hover:text-foreground-active">
