...
import { DefaultSettings, DEVICE_OPTIONS, Orientation } from '@fluxly/constants';
...
import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectSeparator, SelectTrigger, SelectValue } from '@fluxly/ui/select';
import { computeWindowMetadata } from '@fluxly/utility';
        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-row p-0.5 w-3/5 bg-background-secondary rounded">
                    ...
                    >
                        <Icons.Portrait
                            className={`h-4 w-4 ${metadata.orientation !== Orientation.Portrait ? 'text-foreground-secondary hover:text-foreground-fluxly' : ''}`}
                        />
                    </Button>
                    <Button
                        size={'icon'}
                    ...
                    >
                        <Icons.Landscape
                            className={`h-4 w-4 ${metadata.orientation !== Orientation.Landscape ? 'text-foreground-secondary hover:text-foreground-fluxly' : ''}`}
                        />
                    </Button>
                </div>
            </div>
