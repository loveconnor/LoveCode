...
import { BrandTabValue } from '@fluxly/models';
        ...
        <div className="flex flex-col h-full text-xs text-active flex-grow w-full p-0">
            ...
            <div className="flex flex-col gap-3 px-4 pt-4 pb-6 border-b border-border">
                <div className="flex flex-col gap-2">
                    ...
                    <div
                        className="grid grid-cols-12 gap-0 rounded-lg overflow-hidden h-[40px] max-h-[40px] bg-background-fluxly border-[0.5px] border-white/50 hover:border-[0.5px] hover:border-white cursor-pointer hover:border-transparent transition-all duration-200"
