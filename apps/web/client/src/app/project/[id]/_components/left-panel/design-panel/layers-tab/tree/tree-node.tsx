...
import { MouseAction } from '@fluxly/models/editor';
import type { DomElement, LayerNode } from '@fluxly/models/element';
import { Icons } from '@fluxly/ui/icons';
import { NodeIcon } from '@fluxly/ui/node-icon';
        ...
        ({
            ...
            const sendMouseEvent = useCallback(
                async (
                    ...
                    if (!frameData?.view?.getElementByDomId) {
