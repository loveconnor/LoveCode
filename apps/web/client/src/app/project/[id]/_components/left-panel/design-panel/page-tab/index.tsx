...
import { Tooltip, TooltipContent, TooltipPortal, TooltipTrigger } from '@fluxly/ui/tooltip';
        ...
        >
            <div className="m-0 flex flex-row items-center justify-between gap-2">
                <div className="relative flex-grow">
                    ...
                    {searchQuery && (
                        <button
                            className="hover:bg-background-fluxly group absolute top-[1px] right-[1px] bottom-[1px] flex aspect-square items-center justify-center rounded-r-[calc(theme(borderRadius.md)-1px)] active:bg-transparent"
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button
                            variant={'default'}
                            size={'icon'}
                            className="text-foreground-primary border-border-primary hover:border-border-fluxly bg-background-secondary hover:bg-background-fluxly h-fit w-fit border p-2"
