...
import { Popover, PopoverAnchor, PopoverContent } from '@fluxly/ui/popover';
                                ...
                                <div className="flex flex-col gap-1" key={group.name}>
                                    ...
                                    <div className="flex flex-col">
                                        {sortedConversations.map((conversation) => (
                                            <div
                                                className={cn(
                                                    'flex flex-row w-full py-2 items-center rounded-md hover:bg-background-fluxly cursor-pointer select-none group relative',
                                                    conversation.id ===
                                                    editorEngine.chat.conversation.current?.id &&
                                                    'bg-background-fluxly text-primary font-semibold',
                                                )}
                                                key={conversation.id}
                                                onClick={() =>
