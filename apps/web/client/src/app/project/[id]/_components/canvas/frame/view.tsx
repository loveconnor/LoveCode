...
import { PENPAL_PARENT_CHANNEL } from '@fluxly/penpal';
import { WebPreview, WebPreviewBody } from '@fluxly/ui/ai-elements';
        ...
        (
            ...
            const remoteMethods = useMemo((): PromisifiedPendpalChildMethods => {
                ...
                return {
                    ...
                    getFirstFluxlyElement: promisifyMethod(penpalChild?.getFirstFluxlyElement),
                    ...
                    getInsertFeedbackRect: promisifyMethod(penpalChild?.getInsertFeedbackRect),
