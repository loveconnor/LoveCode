...
import { HotkeyLabel } from '@fluxly/ui/hotkey-label';
...
export const TopBar = observer(() => {
    ...
    return (
        <div className="flex flex-row h-10 p-0 justify-center items-center bg-background-fluxly/60 backdrop-blur-xl">
