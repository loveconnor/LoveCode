...
import type { TailwindColor } from '@fluxly/models/style';
import {
    ColorPicker,
    Gradient,
    type GradientState
} from '@fluxly/ui/color-picker';
import { parseGradientFromCSS } from '@fluxly/ui/color-picker/Gradient';
import { Icons } from '@fluxly/ui/icons';
import { Input } from '@fluxly/ui/input';
import { Separator } from '@fluxly/ui/separator';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@fluxly/ui/tabs';
import { cn } from '@fluxly/ui/utils';
import { Color, toNormalCase, type Palette } from '@fluxly/utility';
                    ...
                    <TabsContent value={TabValue.BRAND} className="p-0 m-0 text-xs">
                        <div className="border-b border-t">
                            <div className="relative">
                                ...
                                {searchQuery && (
                                    <button
                                        className="absolute right-[1px] top-[1px] bottom-[1px] aspect-square hover:bg-background-fluxly active:bg-transparent flex items-center justify-center rounded-r-[calc(theme(borderRadius.md)-1px)] group"
