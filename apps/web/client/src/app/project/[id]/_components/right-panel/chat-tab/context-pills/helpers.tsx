import { getContextClass, getContextLabel } from '@fluxly/ai';
import { DefaultSettings } from '@fluxly/constants';
import { MessageContextType, type MessageContext } from '@fluxly/models/chat';
import { NodeIcon } from '@fluxly/ui/node-icon';
import { getTruncatedFileName } from '@fluxly/ui/utils';
