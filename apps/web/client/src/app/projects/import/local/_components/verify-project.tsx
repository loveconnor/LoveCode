...
export const VerifyProject = () => {
    ...
    const renderHeader = () => {
        if (!validation) {
            return (
                <>
                    <CardTitle>{'Verifying compatibility with Fluxly'}</CardTitle>
                    <CardDescription>
                        {"We're checking to make sure this project can work with Fluxly"}
                    </CardDescription>
                </>
            );
        }
        if (validation?.isValid) {
            return (
                <>
                    ...
                    <CardDescription>{'Your project is ready to import to Fluxly'}</CardDescription>
                </>
            );
        } else {
            return (
                <>
                    <CardTitle>{"This project won't work with Fluxly"}</CardTitle>
                    <CardDescription>
                        {'Fluxly only works with NextJS + React + Tailwind projects'}
                    </CardDescription>
                </>
            );
        }
