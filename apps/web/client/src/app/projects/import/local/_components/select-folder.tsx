...
import { IGNORED_UPLOAD_DIRECTORIES, IGNORED_UPLOAD_FILES } from '@fluxly/constants';
import { Button } from '@fluxly/ui/button';
import { CardDescription, CardTitle } from '@fluxly/ui/card';
import { Icons } from '@fluxly/ui/icons';
import { isBinaryFile } from '@fluxly/utility';
...
export const NewSelectFolder = () => {
    ...
    const renderHeader = () => {
        const headerConfig = {
            ...
            validating: {
                title: 'Verifying compatibility with Fluxly',
                description: "We're checking to make sure this project can work with Fluxly",
            },
            valid: {
                title: 'Project verified',
                description: 'Your project is ready to import to Fluxly',
            },
            invalid: {
                title: "This project won't work with Fluxly",
                description: 'Fluxly only works with NextJS + React + Tailwind projects',
            },
        };
