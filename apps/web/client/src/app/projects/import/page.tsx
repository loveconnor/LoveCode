...
import { Card, CardDescription, CardHeader, CardTitle } from '@fluxly/ui/card';
                    ...
                    <CardHeader className="flex flex-col justify-between h-full">
                        ...
                        <div className="space-y-2">
                            ...
                            <CardDescription className="text-sm text-balance">
                                Select a directory from your computer to start working with your project in Fluxly.
                            </CardDescription>
                        </div>
                    </CardHeader>
                </Card>
