...
import { SandboxTemplates, Templates } from '@fluxly/constants';
...
const RECENT_SEARCHES_KEY = 'fluxly_recent_searches';
const RECENT_COLORS_KEY = 'fluxly_recent_colors';
...
export const TopBar = ({ searchQuery, onSearchChange }: TopBarProps) => {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto flex items-center justify-between p-4 text-small text-foreground-secondary gap-6">
            <Link href={Routes.HOME} className="flex items-center justify-start mt-0 py-3 gap-2">
                <Icons.FluxlyLogo className="w-6 h-6" />
                <span className="font-medium text-lg tracking-tight text-foreground">Fluxly</span>
            </Link>
