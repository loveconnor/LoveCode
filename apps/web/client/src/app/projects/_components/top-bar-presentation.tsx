...
import type { User } from '@fluxly/models';
import { Avatar, AvatarFallback, AvatarImage } from '@fluxly/ui/avatar';
...
import { getInitials } from '@fluxly/utility';
...
export const TopBarPresentation = ({
    ...
    return (
        <div className="w-full max-w-6xl mx-auto flex items-center justify-between p-4 text-small text-foreground-secondary gap-6">
            <Link href={homeRoute} className="flex items-center justify-start mt-0 py-3 gap-2">
