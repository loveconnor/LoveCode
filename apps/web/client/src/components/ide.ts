import { IdeType } from '@fluxly/models/ide';
import type { Icons } from '@fluxly/ui/icons';
import { assertNever } from '@fluxly/utility';
...
export class IDE {
    ...
    static readonly ONLOOK = new IDE('Code Panel', IdeType.ONLOOK, 'fluxly', 'FluxlyLogo');
