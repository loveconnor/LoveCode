import type { DomElement, DomElementStyles, Font } from '@fluxly/models';
import {
    type Change,
    type StyleActionTarget,
    type UpdateStyleAction,
} from '@fluxly/models/actions';
import { StyleChangeType, type StyleChange } from '@fluxly/models/style';
import { convertFontString } from '@fluxly/utility';
