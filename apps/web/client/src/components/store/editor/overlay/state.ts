import type { DomElementStyles, RectDimensions } from '@fluxly/models';
...
export interface InsertFeedbackState {
    rect: RectDimensions;
}
...
export class OverlayState {
    ...
    insertFeedback: InsertFeedbackState | null = null;
    ...
    updateInsertFeedback = (rect: RectDimensions | null) => {
        this.insertFeedback = rect ? { rect } : null;
    };
