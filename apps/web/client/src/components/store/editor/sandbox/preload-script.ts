import type { Provider } from '@fluxly/code-provider';
import { NEXT_JS_FILE_EXTENSIONS, ONLOOK_DEV_PRELOAD_SCRIPT_PATH, ONLOOK_DEV_PRELOAD_SCRIPT_SRC } from '@fluxly/constants';
import { RouterType, type RouterConfig } from '@fluxly/models';
import { getAstFromContent, getContentFromAst, injectPreloadScript } from '@fluxly/parser';
import { isRootLayoutFile, normalizePath } from '@fluxly/utility';
