import type { OGImage, PageMetadata, TitleMetadata } from '@fluxly/models';
...
const DEFAULT_DESCRIPTION = 'Generated by Fluxly';
...
export const MetadataForm = ({
    ...
    const renderTitle = () => {
        if (isSimpleTitle) {
            return (
                <div className="grid grid-cols-2 text-foreground-fluxly">
            ...
            return (
                <div className="flex flex-col gap-4">
                    <h2 className="text-title3 text-foreground-fluxly">Title Settings</h2>
        ...
        <div className="text-sm flex flex-col h-full">
            <div className="flex flex-col gap-6 p-6 pb-24 overflow-y-auto flex-1">
                ...
                <div className="grid grid-cols-2 h-44">
                    <div className="flex flex-col text-foreground-fluxly col-span-1 max-w-52">
                ...
                <div className="flex flex-col gap-2">
                    <h2 className="text-regular text-foreground-fluxly">Search Engine Preview</h2>
