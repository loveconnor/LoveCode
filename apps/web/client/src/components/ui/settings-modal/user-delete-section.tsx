...
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from '@fluxly/ui/dialog';
                        ...
                        <DialogDescription asChild className="pt-2">
                            <div className="space-y-2">
                                ...
                                <div className="space-y-1 text-sm">
                                    ...
                                    <div className="flex items-start gap-2">
                                        <span className="mt-0.5">•</span>
                                        <span>Delete all of your projects from Fluxly's servers.</span>
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <span className="mt-0.5">•</span>
