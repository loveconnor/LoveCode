...
import { MotionCard } from '@fluxly/ui/motion-card';
...
export const EnterpriseCard = ({
    ...
    const handleContactUs = () => {
        const subject = encodeURIComponent('[Enterprise]: Fluxly Enterprise Inquiry');
        const body = encodeURIComponent(`Hi Daniel,

I'm interested in learning more about Fluxly's enterprise offering for our organization.
...
[Your name]`);
        ...
        window.location.href = `mailto:daniel@fluxly.com?subject=${subject}&body=${body}`;
    };
        ...
        >
            <motion.div className="p-6 flex flex-col h-full">
                <div className="space-y-1">
                    ...
                    <p className="text-foreground-fluxly text-largePlus">{ENTERPRISE_TIER.price}</p>
                </div>
