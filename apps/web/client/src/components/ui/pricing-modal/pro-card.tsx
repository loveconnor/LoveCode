...
import { PriceKey, PRO_PRODUCT_CONFIG } from '@fluxly/stripe';
...
import { Select, SelectContent, SelectGroup, SelectItem, SelectTrigger, SelectValue } from '@fluxly/ui/select';
        ...
        >
            <motion.div className="p-6 flex flex-col h-full">
                <div className="space-y-1">
                    ...
                    <p className="text-foreground-fluxly text-largePlus">{formatPrice(selectedTierData?.cost ?? 0)}</p>
                </div>
