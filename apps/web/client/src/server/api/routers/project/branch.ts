import { CodeProvider, getStaticCodeProvider } from '@fluxly/code-provider';
import { getSandboxPreviewUrl, SandboxTemplates, Templates } from '@fluxly/constants';
import { branches, branchInsertSchema, branchUpdateSchema, canvases, createDefaultFrame, frames, fromDbBranch, fromDbFrame } from '@fluxly/db';
import type { Frame } from '@fluxly/models';
import { calculateNonOverlappingPosition, generateUniqueBranchName } from '@fluxly/utility';
