import { initModel, SUGGESTION_SYSTEM_PROMPT } from '@fluxly/ai';
import { conversations } from '@fluxly/db';
import type { ChatSuggestion } from '@fluxly/models';
import { LLMProvider, OPENROUTER_MODELS } from '@fluxly/models';
import { ChatSuggestionsSchema } from '@fluxly/models/chat';
