...
export function setFrameId(frameId: string) {
    (window as any)._fluxlyFrameId = frameId;
}

export function getFrameId(): string {
    const frameId = (window as any)._fluxlyFrameId;
    if (!frameId) {
...
export function setBranchId(branchId: string) {
    (window as any)._fluxlyBranchId = branchId;
}

export function getBranchId(): string {
    const branchId = (window as any)._fluxlyBranchId;
    if (!branchId) {
