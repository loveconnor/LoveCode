---
title: UI Overview
description: Overview of the Fluxly user interface
---

# UI Overview

Fluxly's interface is designed to be intuitive for designers while providing powerful capabilities for editing React components.

## Main Interface Areas

The Fluxly interface is divided into several key areas:
...
Fluxly provides various keyboard shortcuts to speed up your workflow:
