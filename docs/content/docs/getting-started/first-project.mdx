...
description: Learn how to create your first project in Fluxly
---

# Creating Your First Project

This tutorial will guide you through creating your first project in Fluxly.
...
Take some time to explore the Fluxly interface:
