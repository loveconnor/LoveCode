...
description: Overview of Fluxly's features
---

# Fluxly Features

Fluxly provides a range of features to help designers and developers work together more efficiently.

{/* ![Features Overview](/images/features-overview.png) */}
*Fluxly offers powerful features to streamline your design-to-code workflow*
...
<Cards>
  ...
  <Card title="Figma to Fluxly" href="#figma-to-fluxly" />
</Cards>
...
*Fluxly's Visual Editor provides a familiar design tool interface*

## Code Integration

Fluxly integrates seamlessly with your code, allowing you to:
...
Fluxly's AI assistance helps you:
...
Import your Figma designs directly into Fluxly to:
...
{/* ![Figma to Fluxly](/images/figma-to-fluxly.png) */}
