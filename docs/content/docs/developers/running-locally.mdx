...
This guide will set you up with a local development environment for Fluxly. This involves a Next.js app, a Supabase backend, and the ability to run dev containers with Codesandbox.

> **Note**: This guide is for development and contributing to Fluxly. For deploying Fluxly for production use, see [Self-Hosting](/self-hosting).

## Prerequisites

These are the prerequisites for setting up Fluxly development environment.
...
### 1. Clone the repository
   ...
   ```bash
   git clone https://github.com/fluxly-dev/fluxly.git
   cd fluxly
   bun install
   ```
...
Now that you have Fluxly running locally, explore these resources to make your first contribution or learn more about the architecture. Understanding how Fluxly works will help you contribute more effectively to this visual editor for React and TailwindCSS.
