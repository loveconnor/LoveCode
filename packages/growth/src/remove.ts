...
import type { FileOperations } from '@fluxly/utility';
import { generate, getAstFromContent, t, traverse } from '@fluxly/parser';

import { getLayoutPath } from './helpers';

/**
 * Removes the Built with Fluxly script from a Next.js layout file
