...
(function () {
    if (typeof window !== 'undefined') {
        ...
        class BuiltWithFluxly extends HTMLElement {
            constructor() {
                super();
                ...
                // Add SVG path for the Fluxly logo
                ...
                text.textContent = 'Built with Fluxly';

                badge.appendChild(svg);
                badge.appendChild(text);

                badge.addEventListener('click', () => {
                    window.open('https://fluxly.com', '_blank');
                });
        ...
        customElements.define('built-with-fluxly', BuiltWithFluxly);

        // Run after page load
        window.addEventListener('load', function () {
            // Create and append the custom element
            const badge = document.createElement('built-with-fluxly');
