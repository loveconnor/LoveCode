...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Close render={<Button />} className={cn(buttonVariants(), className)} {...props} />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Close render={<Button />} className={cn(buttonVariants({ variant: "outline" }), className)} {...props} />
  )
}
