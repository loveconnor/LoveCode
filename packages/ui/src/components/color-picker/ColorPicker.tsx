...
import { Color, mod } from '@fluxly/utility';
...
const Input = tw(DraftableInput)`
  outline-0 w-full h-6 bg-background-fluxly/70 rounded focus:ring-1 ring-inset ring-foreground-active text-foreground-primary placeholder:text-foreground-disabled text-center
`;
