...
export const ONLOOK_CACHE_DIRECTORY = '.fluxly';

// Preload script. Fetch from local public folder in dev, fetch from CDN in prod.
export const ONLOOK_PRELOAD_SCRIPT_FILE = 'fluxly-preload-script.js';
...
const ONLOOK_PROD_PRELOAD_SCRIPT_SRC =
    'https://cdn.jsdelivr.net/gh/fluxly-dev/fluxly@d3887f2/apps/web/client/public/fluxly-preload-script.js';
...
export const DEPRECATED_PRELOAD_SCRIPT_SRCS = [
    'https://cdn.jsdelivr.net/gh/fluxly-dev/fluxly@main/apps/web/client/public/fluxly-preload-script.js',
