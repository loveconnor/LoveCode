  ...
  return (
    <html lang="en" suppressHydrationWarning data-oid="o7v_4be">
            <head data-oid="795jc-7">
                <Script
          type="module"
          src="https://cdn.jsdelivr.net/gh/fluxly-dev/fluxly@main/apps/web/preload/dist/index.js"
          data-oid="m4pfglr" />


                <Script
          type="module"
          src="https://cdn.jsdelivr.net/gh/fluxly-dev/web@latest/apps/web/preload/dist/index.js"
          data-oid="yujojk-" />
