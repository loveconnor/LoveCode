import { DEPRECATED_PRELOAD_SCRIPT_SRCS, ONLOOK_PRELOAD_SCRIPT_SRC } from '@fluxly/constants';
    ...
    return t.jsxElement(
        t.jsxOpeningElement(
            ...
            [
                ...
                t.jsxAttribute(t.jsxIdentifier('id'), t.stringLiteral('fluxly-preload-script')),
            ],
            false,
        ),
