...
import { ONLOOK_CACHE_DIRECTORY, ONLOOK_PRELOAD_SCRIPT_FILE } from '@fluxly/constants';
...
import { isRootLayoutFile, pathsEqual } from '@fluxly/utility';
...
export class CodeFileSystem extends FileSystem {
    ...
    private isJsxFile(path: string): boolean {
        // Exclude the Fluxly preload script from JSX processing
